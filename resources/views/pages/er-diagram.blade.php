    ...
    >
        ...
        <div class="flex flex-wrap items-center gap-3 mb-4">
            ...
            <div class="flex items-center gap-1 ml-auto">
                <x-filament::button color="gray" size="sm" x-on:click="erZoom(1.4)">+</x-filament::button>
                <x-filament::button color="gray" size="sm" x-on:click="erZoomReset()">
                    {{ __('filament-er-diagram::translations.zoom_fit') }}
                </x-filament::button>
                <x-filament::button color="gray" size="sm" x-on:click="erZoom(0.7)">−</x-filament::button>
            </div>

            <div class="flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-gray-400 border-l pl-4">
                <span class="flex items-center gap-1.5">
                    <span class="inline-block w-5 h-0.5 bg-blue-500 rounded"></span>hasMany</span>
                <span class="flex items-center gap-1.5">
                    <span class="inline-block w-5 border-t border-dashed border-gray-400"></span>belongsTo</span>
                <span class="flex items-center gap-1.5">
                    <span class="inline-block w-5 h-0.5 bg-green-500 rounded"></span>hasOne</span>
                <span class="flex items-center gap-1.5">
                    <span class="inline-block w-5 h-0.5 bg-purple-400 rounded"></span>many:many</span>
            </div>
        </div>
        ...
        >
            ...
            <div class="absolute bottom-0 inset-x-0 flex items-center gap-4 px-4 py-2
